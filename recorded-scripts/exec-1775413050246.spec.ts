...
test('Recorded flow', async ({ page, context }) => {
  ...
  const L = {
    allowAllCookiesButton: page.locator('xpath=//button[normalize-space(text())=\'Allow all cookies\']').first(),
    ...
    getStartedLink      : page.locator('xpath=//a[normalize-space(text())=\'Get Started\']').first(),
  ...
  await L.allowAllCookiesButton.click();
