// 'AUTOMATION' is the scheduler tab from main; the nav renders no active state
// for it, which is correct, but the union has to admit it.
export type CodeLensMode = 'SETUP' | 'HISTORY' | 'COMPARE' | 'REVIEW' | 'REPORT' | 'AUTOMATION';
